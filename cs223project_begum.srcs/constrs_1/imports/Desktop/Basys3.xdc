...
# LEDs 
set_property PACKAGE_PIN U16 [get_ports {data2[0]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {data2[0]}] 
set_property PACKAGE_PIN E19 [get_ports {data2[1]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {data2[1]}] 
set_property PACKAGE_PIN U19 [get_ports {data2[2]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {data2[2]}] 
set_property PACKAGE_PIN V19 [get_ports {data2[3]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {data2[3]}] 
set_property PACKAGE_PIN W18 [get_ports {data2[4]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {data2[4]}] 
set_property PACKAGE_PIN U15 [get_ports {data2[5]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {data2[5]}] 
set_property PACKAGE_PIN U14 [get_ports {data2[6]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {data2[6]}] 
set_property PACKAGE_PIN V14 [get_ports {data2[7]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {data2[7]}] 
#set_property PACKAGE_PIN V13 [get_ports {dataOut[0]}]  	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {dataOut[0]}] 
#set_property PACKAGE_PIN V3 [get_ports {dataOut[1]}] 	 	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {dataOut[1]}] 
set_property PACKAGE_PIN W3 [get_ports {page[0]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {page[0]}] 
set_property PACKAGE_PIN U3 [get_ports {page[1]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {page[1]}] 
#set_property PACKAGE_PIN P3 [get_ports {dataOut[4]}]  	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {dataOut[4]}] 
#set_property PACKAGE_PIN N3 [get_ports {dataOut[5]}]  	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {dataOut[5]}] 
#set_property PACKAGE_PIN P1 [get_ports {dataOut[6]}]  	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {dataOut[6]}] 
set_property PACKAGE_PIN L1 [get_ports {whichMem}]  	 	 	 	  			
	set_property IOSTANDARD LVCMOS33 [get_ports {whichMem}] 
